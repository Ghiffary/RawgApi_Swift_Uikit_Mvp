...
class MainbarController: UIViewController {
    ...
    func initializeFunction(){
        activityIndicator.backgroundColor = .systemPink
    ...
    func collectionViewConstraints(){
        ...
        gameTableView.layer.borderColor = UIColor.systemPink.cgColor
    ...
    func imageScrollViewConstraints(){
        ...
        imageScrollView.layer.borderColor = UIColor.systemPink.cgColor
