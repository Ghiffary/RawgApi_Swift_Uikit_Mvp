...
class Onboarding : UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
                ...
                slides = [
                    OnboardSlider(title: "WIN THE GAME BEFORE IT'S PLAYED", description: "With unlimited amounth knowledge behind couple clicks.", image: "hai"),
                    OnboardSlider(title: "Choose your game wisely", description: "You can't judge a fish by its ability to climb a tree. Lets find your ocean together.", image: "think"),
                    OnboardSlider(title: "Just play. Have fun. Enjoy the GAME", description: "Without passion, you are already dead.", image: "game")
                ]
